  ...
  <form class="form container <?php if(count($errors)) : echo 'form--invalid'; endif; ?>" action="registration.php" method="post" autocomplete="off" enctype="multipart/form-data"> <!-- form--invalid -->
